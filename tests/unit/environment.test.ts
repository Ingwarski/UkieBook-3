...
describe("environment contracts", () => {
  it("validates server-only configuration with deterministic defaults", () => {
    ...
    expect(environment).toEqual({
      ...
      DATABASE_URL: "postgres://ukiebook:ukiebook@localhost:5432/ukiebook",
      EMAIL_FROM: "UkieBook <noreply@ukiebook.local>",
      GOOGLE_DOCS_EXPORT_ORIGIN: "https://docs.google.com",
      JOB_LEASE_SECONDS: 60,
      JOB_MAX_ATTEMPTS: 5,
      MONO_API_ORIGIN: "https://api.monobank.ua",
      PAYMENT_RECONCILIATION_INTERVAL_MS: 30_000,
      PAYMENT_SESSION_VALIDITY_SECONDS: 3_600,
      PAYMENT_WEBHOOK_MAX_BYTES: 65_536,
