...
- Migration `0005_moderation_publication`, `modules/moderation/`, S-13/S-18/S-02 UNIT-04 routes, `scripts/verify-unit04-postgres.ts`, `tests/e2e-unit04/`, `tests/visual-unit04/` and `scripts/run-unit04-verification.mjs` — implemented UNIT-04 verification surface. `npm run verify:unit04` has not yet produced a canonical receipt, so these sources define expected evidence but pass no check by themselves.

Product-route, journey and release checks below remain `blocked` until their owning units produce fresh implementation evidence. UNIT-00 platform foundation, UNIT-01 identity/profile, UNIT-02 behavior/persistence, UNIT-02-C1 V3 visual correction and UNIT-03 publishing/conversion execution recorded next are scoped passed exceptions. UNIT-04 implementation exists, but remains `pending` until its canonical verifier seals revision-bound evidence; Baseline approval and test source code alone do not pass runtime checks.
...
- **Historical Next Unit:** UNIT-03, now completed; current next executable unit is UNIT-04.
...
- **Explicit Limit:** no UNIT-04 Manager Manual Review, moderation decision, rejection, publication activation, S-13/S-18 lifecycle, or public catalog projection is passed. The Author journey ends at `BookSubmitted`; UNIT-04 is next.

### UNIT-04 Moderation And Publication Execution (canonical verification pending)

- **Verification Status:** `pending`. No canonical UNIT-04 receipt path/status is recorded until a clean committed revision completes `npm run verify:unit04`; none of the UNIT-04 checks below is yet marked `passed`.
- **Implemented Scope To Verify:** migration `0005`; idempotent `BookSubmitted` relay; safe clear auto-publication; flagged/provider-outage Manual Review; immutable screening/decision/publication audit; closed ReasonCategory and removal-ground contracts; separate active-publication pointer; atomic Catalog activation/removal; publication-gated public Cover; S-13 lifecycle; S-18 type-specific decisions; S-02 unavailable. BookUpdate/Review are decision/event contracts only—producer and downstream application remain later owning units.
- **Required Functional Evidence:** dedicated real PostgreSQL rollback/reapply and invariant proof; decision replay/concurrency; Guest redirect, Author denial and denied Author decision; invalid Origin and invalid CSRF with unchanged case; Author/public DTO and event inspection proving no internal AI signal; E2E Book approval/rejection, Update approval/rejection contract, Review publish/do-not-publish contract and confirmed FR-LIC-4 removal.
- **Required Visual Evidence:** exactly 50 revision-bound screenshots over S-13, S-18 and S-02 unavailable at 390/430/768/1280/1440 with required core states, zero console/page errors and no horizontal overflow. This is Aurora V3 extension coverage, not S-01 pixel-lock.
- **Required Accessibility Evidence (8):** `s13-keyboard-order-focus-activation`, `s13-reflow-200`, `s18-queue-keyboard-list-detail`, `s18-reason-validation-focus`, `s18-removal-dialog-focus-trap-return`, `s18-mobile-list-detail-back`, `s18-reflow-200`, `s02-unavailable-reflow-200`.
...
| VIS-AURORA-AUTHOR | `AVB-UKIEBOOK-AURORA-7B-V3` / `e50c9f82c241195d7f5d8876d9dcdcd7fd45b71cdaf6d2eedfe2e327a7182724` | S-10…S-17, applicable states, 390/768/1280 | P2 / blocking | calmer forms/tables within Aurora | token/component/state evidence | preserve brand and task clarity | S-10/S-11/S-12 scoped passed by UNIT-03 with 30 receipts; S-13…S-16 remain blocked; S-17 prior behavior remains UNIT-01 history |
...
| VIS-BRAND-LOGO | `AVB-UKIEBOOK-AURORA-7B-V3` / `e50c9f82c241195d7f5d8876d9dcdcd7fd45b71cdaf6d2eedfe2e327a7182724` | all rendered logo instances, default/focus/high-density, 390/768/1280/1440 | P2 / blocking | active transparent SVG only; no backing plate; locked brand geometry preserved | source SHA-256 `db838dd4ad696f63cccb6aa86ab98e53dc5c6e13c1778ac340f62c5e4514617f`, alpha/background inspection + captures against V3 | explicit transparent-logo correction; raster-backed container is not claimed as path-vector | S-01/S-02 passed by UNIT-02-C1; S-10/S-11/S-12 rendered instances scoped passed by UNIT-03; other visible routes require a current V3 receipt when touched |
...
Blockers: product implementation units UNIT-04…UNIT-10 and the unimplemented portions of S-04…S-09/S-13…S-16/S-18…S-21 plus complete release-journey evidence are not complete; credentialed Google/Facebook smoke blocks production provider activation; legal/tax review (OQ-1), mono production terms (OQ-2), and production font license/provenance remain open. UNIT-00, UNIT-01 behavior, UNIT-02 behavior/persistence, UNIT-02-C1 V3 correction and UNIT-03 through `BookSubmitted` are current only within their recorded scopes. MOBI engine proof is closed; next executable unit is UNIT-04 for Manual Review, moderation decisions and publication activation.
