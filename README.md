...
- `UNIT-02-C1` реалізує active V3 correction: усі кути Обкладинок `0px`, сім унікальних baked-artwork Covers, необрізана перша полиця, exact hero copy, public `35/65`, manager-only `29+6+65` і transparent SVG logo. Revision-bound verification evidence ще не зафіксовано в цьому проміжному стані.
